...
def main():   
            ...
            img = cv2.imread(r'20230901_fiber\label2\2\not_ave\910.png'.format(910), flags=cv2.IMREAD_UNCHANGED)  
            ...
            for i in nums(0,20):
                n.append(i)
                ue.append(img[35,629+i])   #ue
                hidari.append(img[508,152+i])  #hidari
                sita.append(img[948,625+i])  #sita
                migi.append(img[494,1073+i]) #migi
                tyuou.append(img[515,624+i])  #tyuou
            ...
            fig, ax = plt.subplots()
            ax.plot(n, ue, 'red')
            ax.plot(n, hidari, 'green')
            ax.plot(n, sita, 'blue')
            ax.plot(n, migi, 'gold')
            ax.plot(n, tyuou, 'magenta')
