...
def main():   
            ...
            img = cv2.imread(r'20230901_fiber\NN\test\top100\{}{}\NN_hm{}.png'.format(n,v,n), flags=cv2.IMREAD_UNCHANGED)
            mask = cv2.imread(r'20230901_fiber\NN\test\top100\{}{}\NN_hm{}.png'.format(n,v,n), flags=cv2.IMREAD_GRAYSCALE)
            data = cv2.imread(r'20230901_fiber\label2\{}\top100\910.png'.format(n), flags=cv2.IMREAD_GRAYSCALE)
            ...
            cv2.imwrite(r'20230901_fiber\NN\test\top100\{}{}\NN_hm_{}-1.png'.format(n,v,n), img1)
            cv2.imwrite(r'20230901_fiber\NN\test\top100\{}{}\NN_hm_{}-2.png'.format(n,v,n), data)
