...
def main():   
            ...
            # img = cv2.imread(r'20230901_fiber\NN\test\top100\{}{}\NN_hm{}.png'.format(n,s,n), flags=cv2.IMREAD_UNCHANGED)
            # mask = cv2.imread(r'20230901_fiber\NN\test\top100\{}{}\NN_hm{}.png'.format(n,s,n), flags=cv2.IMREAD_GRAYSCALE)
            # img = cv2.imread(r'20230901_fiber\NN\test\{}\{}{}\NN_hm{}.png'.format(t,n,v,n), flags=cv2.IMREAD_UNCHANGED)
            # img = cv2.imread(r'20230901_fiber\NN\test\{}\{}\NN_hm{}.png'.format(t,n,n), flags=cv2.IMREAD_UNCHANGED)
            img = cv2.imread(r'20230901_fiber\NN\test\{}\{}{}\NN_hm{}.png'.format(t,n,s,n), flags=cv2.IMREAD_UNCHANGED)
            mask = cv2.imread(r'20230901_fiber\mask\2102.png', flags=cv2.IMREAD_GRAYSCALE)
            
            b1,b2 = np.where(mask == 0)
            img[b1,b2] = 0

            # cv2.imwrite(r'20230901_fiber\NN\test\top100\{}{}\NN_hm_{}-1.png'.format(n,s,n), img1)
            # cv2.imwrite(r'20230901_fiber\NN\test\top100\{}{}\NN_hm_{}-2.png'.format(n,s,n), data)
            # cv2.imwrite(r'20230901_fiber\NN\test\{}\{}{}\NN_hm_{}-3.png'.format(t,n,v,n), img)
            # cv2.imwrite(r'20230901_fiber\NN\test\{}\{}\NN_hm_{}-3.png'.format(t,n,n), img)
            cv2.imwrite(r'20230901_fiber\NN\test\{}\{}{}\NN_hm_{}-3.png'.format(t,n,s,n), img)
