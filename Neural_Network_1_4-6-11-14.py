...
def CV_training (p):
    ...
    a = np.loadtxt(r'20230901_fiber\3Dcube\{}\{}\abs.csv'.format(num, p[0]), delimiter=",")[:,:]
    ...
    b = np.loadtxt(r'20230901_fiber\3Dcube\{}\{}\abs.csv'.format(num, p[1]), delimiter=",")[:,:]
    ...
    c = np.loadtxt(r'20230901_fiber\3Dcube\{}\{}\abs.csv'.format(num, p[2]), delimiter=",")[:,:]
    ...
    d = np.loadtxt(r'20230901_fiber\3Dcube\{}\{}\abs.csv'.format(num, p[3]), delimiter=",")[:,:]
    ...
    e = np.loadtxt(r'20230901_fiber\3Dcube\{}\{}\abs.csv'.format(num, p[4]), delimiter=",")[:,:]
...
def main():
    ...
    for i in range(0,fold_size):
        ...
        my_callbacks = [
            ...
            tf.keras.callbacks.ModelCheckpoint(filepath= r'20230901_fiber/NN/learning/{}/{}otameshi.h5'.format(num, str(i)),save_best_only=True),
        ]
        ...
        for m in range(len(metrics)):
            ...
            pd.DataFrame(plt_train).to_csv(r'20230901_fiber/NN/learning/{}/{}{}_gakushuritsu_train.csv'.format(num, str(i), metrics[m]))
            pd.DataFrame(plt_test).to_csv(r'20230901_fiber/NN/learning/{}/{}{}_gakushuritsu_test.csv'.format(num, str(i), metrics[m]))
        plt.savefig(r'20230901_fiber/NN/learning/{}/{}_gakushuritsu.png'.format(num, str(i)))
        plt.show()  # グラフの表示

        """"save the best model"""
        model.save(filepath=r'20230901_fiber/NN/learning/{}/classification_model.h5'.format(num), save_format='h5')
    ...
    os.rename(r'20230901_fiber/NN/learning/{}/{}otameshi.h5'.format(num, str(best_model_number)), r'20230901_fiber/NN/learning/{}/best_model.h5'.format(num))
