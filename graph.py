...
def main():
            ...
            for p in package:
                ...
                path0 = r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[0])
                path2 = r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[1])
                path4 = r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[2])
                path6 = r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[3])
                path7 = r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[4])
                path9 = r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[5])
                path11= r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[6])
                path14= r'20230901_fiber\3Dcube\{}\{}\496~1600\abs.csv'.format(t, p[7])
                ...
                plt.savefig('20230901_fiber/3Dcube/{}/raw-8_1{}.png'.format(t,t))
                plt.show()
