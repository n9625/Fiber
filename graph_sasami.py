...
def main():
            ...
            for p in package:
                ...
                path1 = r'20231113\3d\top100\sasami\brack\abs.csv'.format(t, p[0])
                path2 = r'20231113\3d\top100\sasami\white\abs.csv'.format(t, p[1])
                path3 = r'20231113\3d\top100\sasami\brack_sasami\abs.csv'.format(t, p[2])
                path4 = r'20231113\3d\top100\sasami\white_sasami\abs.csv'.format(t, p[3])
                ...
                plt.savefig(r'20231113\3d\top100\sasami\raw-8_1{}.png'.format(t))
                plt.show()
