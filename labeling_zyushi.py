...
def main():   
            ...
            #     print('=====')
            #     print(wl)
            mask = cv2.imread(r'20230901_fiber\mask\2\912.png', flags=cv2.IMREAD_UNCHANGED)
            # img = cv2.imread(r'20230901_fiber\affine\14\{}.png'.format(wl), flags=cv2.IMREAD_UNCHANGED)
