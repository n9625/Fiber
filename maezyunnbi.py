...
def main():
    ...
    # cali_mae = (r'20231113\label3\006')
    ...
    # mask_ROI = cv2.imread(r'20231113\ganma\2001.png',cv2.IMREAD_GRAYSCALE)
    ...
    plt.savefig(r'20230901_fiber\3Dcube\{}\{}\ref_ave.png'.format(t, n))
    plt.show()
    ...
    cpath = r'20230901_fiber\3Dcube\{}\{}\abs.csv'.format(t, n)
    np.savetxt(cpath, np.array(ROIData), fmt='%.10f', delimiter=',')
    # cpath = r'20230901_fiber\3Dcube\{}\abs_ave.csv'.format(n)
    cpath = r'20230901_fiber\3Dcube\{}\{}\abs_ave.csv'.format(t, n)
    np.savetxt(cpath, np.average(ROIData,axis=0), fmt='%.10f', delimiter=',')

    seaborn_plot(ROIData,'absorvance')
    plt.title("absorvance")
    # plt.savefig(r'20230901_fiber\3Dcube\{}\abs_ave.png'.format(n))
    plt.savefig(r'20230901_fiber\3Dcube\{}\{}\abs_ave.png'.format(t, n))
    plt.show()
