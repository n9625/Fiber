...
# #               970]
# wavelength = [910,916,922,928,934,940,946,952,958,964,
...
def main():
    ...
    cali_mae = (r'Hyperspectral_imaging_zyushi_03\henkango\whitecal\{}'.format(n))
    ...
    n=0
    """load the mask"""
    # mask_ROI = cv2.imread(r'Hyperspectral_imaging_zyushi_03\henkango\mask\{}\2.png'.format(n),cv2.IMREAD_GRAYSCALE)
    mask_ROI = cv2.imread(r'Hyperspectral_imaging_zyushi_03\henkango\mask\{}\3.png'.format(n),cv2.IMREAD_GRAYSCALE)
    ...
    cpath = r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\ref.csv'.format(n)
    np.savetxt(cpath, np.array(ROIData), fmt='%.10f', delimiter=',')
    # cpath = r'20230901_fiber\3Dcube\{}\ref_ave.csv'.format(n)
    cpath = r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\ref_ave.csv'.format(n)
    ...
    plt.savefig(r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\ref_ave.png'.format(n))
    plt.show()
    ...
    cpath = r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\abs.csv'.format(n)
    np.savetxt(cpath, np.array(ROIData), fmt='%.10f', delimiter=',')
    # cpath = r'20230901_fiber\3Dcube\{}\abs_ave.csv'.format(n)
    cpath = r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\abs_ave.csv'.format(n)
    np.savetxt(cpath, np.average(ROIData,axis=0), fmt='%.10f', delimiter=',')

    seaborn_plot(ROIData,'absorvance')
    plt.title("absorvance")
    # plt.savefig(r'20230901_fiber\3Dcube\{}\abs_ave.png'.format(n))
    plt.savefig(r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\abs_ave.png'.format(n))
    plt.show()
    ...
    cpath = r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\SG.csv'.format(n)
    np.savetxt(cpath, np.array(ROIData), fmt='%.10f', delimiter=',')
    # cpath = r'20230901_fiber\3Dcube\{}\SG_ave.csv'.format(n)
    cpath = r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\SG_ave.csv'.format(n)
    np.savetxt(cpath, np.average(ROIData,axis=0), fmt='%.10f', delimiter=',')

    seaborn_plot(ROIData,'Savitzky-Galoy')
    plt.title("Savitzky-Galoy")
    # plt.savefig(r'20230901_fiber\3Dcube\{}\SG_ave.png'.format(n))
    plt.savefig(r'Hyperspectral_imaging_zyushi_03\henkango\3d\{}\SG_ave.png'.format(n))
    plt.show()
