...
def main():   
            ...
            # img = cv2.imread(r'20230901_fiber\ganma\{}.png'.format(2100), flags=cv2.IMREAD_GRAYSCALE)
            img = cv2.imread(r'20231218_fiber_kaizoudo\ganma\7.png', flags=cv2.IMREAD_GRAYSCALE)
            ...
            # cv2.imwrite(r'20230901_fiber\mask\{}.png'.format(2103), dst)
            cv2.imwrite(r'20231218_fiber_kaizoudo\ganma\8.png', dst)
