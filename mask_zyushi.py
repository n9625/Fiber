...
def main():   
            ...
            # img = cv2.imread(r'20230901_fiber\label2\6\top100\{}.png'.format(1390), flags=cv2.IMREAD_GRAYSCALE)  #6
            ...
            a1,a2 = np.where(img>threshold)
            b1,b2 = np.where((0<img)&(img<threshold))
            img1 = img.copy()
            img2 = img.copy()
            img1[a1,a2] = 0
            img2[b1,b2] = 255
            ...
            ret1, dst1 = cv2.threshold(img1, th, 255, cv2.THRESH_BINARY)
            # dst = cv2.medianBlur(dst, ksize=3)

            cv2.imwrite(r'20230901_fiber\mask\11\{}.png'.format(910), img)
            cv2.imwrite(r'20230901_fiber\mask\11\{}.png'.format(911), dst)
            cv2.imwrite(r'20230901_fiber\mask\11\{}.png'.format(912), dst1)
            cv2.imwrite(r'20230901_fiber\mask\11\{}.png'.format(913), img1)
            cv2.imwrite(r'20230901_fiber\mask\11\{}.png'.format(914), img2)
