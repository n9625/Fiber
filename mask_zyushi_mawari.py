...
def main():   
            ...
            #     print('=====')
            #     print(wl)
            img1 = cv2.imread(r'20230901_fiber\mask\2102.png', flags=cv2.IMREAD_GRAYSCALE)  
            img2 = cv2.imread(r'20230901_fiber\mask\14\2001.png', flags=cv2.IMREAD_GRAYSCALE) 
            # img = img2.copy()
            # img[:,:] = 0


            a1,a2 = np.where(img2!=255)
            img1[a1,a2] = 0

            cv2.imwrite(r'20230901_fiber\mask\14\{}.png'.format(2005), img1)
