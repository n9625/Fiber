...
def CV_training (p):
    ...
    f = np.loadtxt(r'Hyperspectral_imaging_zyushi_03/henkango/3d/{}/abs.csv'.format(p[5]), delimiter=",")[:,:]
    ...
    g = np.loadtxt(r'Hyperspectral_imaging_zyushi_03/henkango/3d/{}/abs.csv'.format(p[6]), delimiter=",")[:,:]
