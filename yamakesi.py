...
def main():   
            ...
            #     print('=====')
            #     print(wl)
            img1 = cv2.imread(r'20231218_fiber_kaizoudo\ganma\4.png', flags=cv2.IMREAD_UNCHANGED)
            img2 = cv2.imread(r'20231218_fiber_kaizoudo\ganma\5.png', flags=cv2.IMREAD_UNCHANGED)

            # img_yamakesi =np.subtract(img1, img2)
            # img_yamakesi[img_yamakesi < 1] = 0
            # img_yamakesi[img_yamakesi > 150] = 0
            img_yamakesi = img1-img2*0.18
            img_yamakesi[img_yamakesi < 1] = 0
            # img_yamakesi = img1-img2*0.25
            # img_yamakesi[img_yamakesi < 1] = 0

            cv2.imwrite(r'20231218_fiber_kaizoudo\ganma\7.png'.format(2100), img_yamakesi)
