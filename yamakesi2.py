...
def main():   
            ...
            #     print('=====')
            #     print(wl)
            img1 = cv2.imread(r'20231218_fiber_kaizoudo\ganma\{}.png'.format(1), flags=cv2.IMREAD_UNCHANGED)
            img2 = cv2.imread(r'20231218_fiber_kaizoudo\ganma\{}.png'.format(2), flags=cv2.IMREAD_UNCHANGED)
            ...
            img_yamakesi = img1-img2
            img_yamakesi[img_yamakesi < 1] = 0

            cv2.imwrite(r'20231218_fiber_kaizoudo\ganma\{}.png'.format(3), img_yamakesi)
